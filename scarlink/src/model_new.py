...
from scarlink.src.read_h5_and_group_cells import construct_cell_info_new, construct_gex_mat_new, get_train_test_split, get_gene_tile_matrix_group_cells, write_significance, read_sparse_significance
...
class RegressionModelNew:
    ...
    def __init__(self, output_dir, log_file_name='', gtf_file = "", scatac_fragment_file = "", out_file_name = 'coefficients.hd5', group_cells = False, mode='a'):
        ...
        # get cell info
        self.scrna_file = output_dir + '/scrna.h5ad'
        self.scatac_file = output_dir + '/scatac.h5ad'
        self.scrna = sc.read_h5ad(self.scrna_file)
        self.scatac = sc.read_h5ad(self.scatac_file)
        self.cell_info = construct_cell_info_new(self.scrna, self.scatac)  
        self.gene_info = scrna.var[scrna.var['seqnames'] is not None].reset_index(names='gene_name')
        # construct sparse scRNA expression matrix
        self.gex_matrix = construct_gex_mat_new(scrna)
        ...
        self.train_ix, self.test_ix = get_train_test_split(None, self.gex_matrix.shape[0], random_state = 9, group_cells = group_cells)
    ...
    def gene_tile_matrix(self, gene):
        ...
        tile_gene_mat = get_gene_tile_matrix_group_cells_new(self.scatac, self.scrna, gene)
